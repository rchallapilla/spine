...
export function SpineWidget({ habits, entries, date }: Props) {
  ...
  return (
    <>
      <section className="relative mx-auto w-full overflow-hidden rounded-[16px] border border-line/70 bg-surface/70 p-3.5 shadow-[inset_0_1px_0_rgba(242,239,230,0.04)]">
        <div
          aria-hidden
        ...
        <div className="relative mx-auto flex w-full flex-col items-center gap-1.5">
          {habits.map((habit, i) => {
            ...
            return (
              ...
              >
                <button
                  ...
                  className={cn(
                    "spine-segment-fill flex min-h-12 flex-1 items-center justify-between rounded-[12px] border px-3.5 text-sm",
                    filled
                      ? "border-accent/80 bg-accent text-bg shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_0_0_1px_rgba(62,207,186,0.15)]"
                      : "border-line bg-surface-2/80 text-text shadow-[inset_0_1px_0_rgba(242,239,230,0.03)]",
                  )}
                >
                  <span className="font-medium tracking-tight">{habit.label}</span>
                  <span
                    className={cn(
                      "font-mono text-xs",
                ...
                <button
                  ...
                  className="flex w-10 shrink-0 items-center justify-center rounded-[12px] border border-line bg-surface-2/60 text-text-dim transition-colors hover:border-accent/40 hover:text-accent"
                >
                  &#9432;
                </button>
              </div>
